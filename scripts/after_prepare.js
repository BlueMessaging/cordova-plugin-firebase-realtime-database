...
function updateStringsXml(contents) {
    ...
    // strip non-default value
    strings = strings.replace(new RegExp('<string name="google_crash_reporting_api_key">([^\@<]+?)</string>', 'i'), '');
    ...
    // replace the default value
    strings = strings.replace(new RegExp('<string name="firebase_database_url">([^<]+?)</string>', 'i'), '<string name="firebase_database_url">' + json.project_info.firebase_url + '</string>');

    // replace the default value
    strings = strings.replace(new RegExp('<string name="google_crash_reporting_api_key">([^<]+?)</string>', 'i'), '<string name="google_crash_reporting_api_key">' + json.client[0].api_key[0].current_key + '</string>');
